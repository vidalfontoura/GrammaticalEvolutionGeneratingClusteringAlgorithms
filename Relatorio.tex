...
\begin{document}
	...
	\begin{table}[!htb]
		...
		\label{silhouette-results-ge-and-kmeans}
		\begin{tabular}{|c|c|c|c|}
			\hline
			\textbf{Dataset}                                                                                         & \textbf{Algorithm}                                 & \textbf{Statistics}             & \textbf{Fitness}                          \\ \hline
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Average & \cellcolor[HTML]{FFFFFF}\textbf{0.615165} \\ \cline{3-4} 
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Std Dev & \cellcolor[HTML]{FFFFFF}0,089821          \\ \cline{3-4} 
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Min     & \cellcolor[HTML]{FFFFFF}0,414012          \\ \cline{3-4} 
			& \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}GE-Clust} & \cellcolor[HTML]{FFFFFF}Max     & \cellcolor[HTML]{FFFFFF}0,729177          \\ \cline{2-4} 
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Average & \cellcolor[HTML]{FFFFFF}0,570102          \\ \cline{3-4} 
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Std Dev & \cellcolor[HTML]{FFFFFF}0,000000          \\ \cline{3-4} 
			& \cellcolor[HTML]{FFFFFF}                           & \cellcolor[HTML]{FFFFFF}Min     & \cellcolor[HTML]{FFFFFF}0,570102          \\ \cline{3-4} 
			\multirow{-8}{*}{\begin{tabular}[c]{@{}c@{}}Pima Indians\\ Diabetes\end{tabular}}                        & \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}K-Means}  & \cellcolor[HTML]{FFFFFF}Max     & \cellcolor[HTML]{FFFFFF}0,570102          \\ \hline
			...
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Average                         & 0,605818                                  \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Std Dev                         & 0,023390                                  \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Min                             & 0,541715                                  \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}GE-Clust} & Max                             & 0,621250                                  \\ \cline{2-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Average                         & \textbf{0,624822}                         \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Std Dev                         & 0,000008                                  \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\cellcolor[HTML]{FFFFFF}                                                                                 & \cellcolor[HTML]{FFFFFF}                           & Min                             & 0,624818                                  \\ \cline{3-4} 
			\rowcolor[HTML]{FFFFFF} 
			\multirow{-8}{*}{\cellcolor[HTML]{FFFFFF}\begin{tabular}[c]{@{}c@{}}Glass\\ Identification\end{tabular}} & \multirow{-4}{*}{\cellcolor[HTML]{FFFFFF}K-Means}  & Max                             & 0,624836                                  \\ \hline

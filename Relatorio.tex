...
\begin{document}
	...
	%S É preciso explicar melhor, reescrever a frases abaixo.
	%S explicar que pegou as medias e também como o k foi estabelecido em ambos os casos CE-Clust e K-means.
	...
	%S vcs falam que executam com k values o k-means pq está fixo na tabela?
	...
	%S n�o entendi... vcs nao pegaram o melhor dos k do k-means? pelo menos � o que falaram acima.....
	...
	%S Colocar tabela em uma unica coluna. Por ex tirar coluna true e usar negrito,  e tirar palavra fixed.
	...
	%S nao sei se deveriamos deixar estes tempos....
	...
	%S que time constraints sao estas? Acaba depondo conta, reescrever.

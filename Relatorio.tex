...
The GE-Clust was executed 10 independent runs with each dataset using the same configuration presented in Table~\ref{ge-configuration}. The evaluation of the individuals was made using the fitness function presented on Equation~\ref{eq:fitness}.
